...
CREATE TABLE `products` (
    ...
    `productPicUrl` VARCHAR(191) NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
    `userId` INTEGER NULL,
...
-- AddForeignKey
ALTER TABLE `users` ADD CONSTRAINT `users_roleIdId_fkey` FOREIGN KEY (`roleIdId`) REFERENCES `roles`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
